...
names(cv.carseats)
plot(cv.carseats) # Here we see the misclassicifations for different size.
...
# Compare to bagging, random forest proceeds in the exact same way, except that we use a samller value for "mtry"
